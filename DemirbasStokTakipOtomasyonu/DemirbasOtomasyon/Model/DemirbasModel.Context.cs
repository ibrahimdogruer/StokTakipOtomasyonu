...
public partial class DemirbasTakipEntitiess : DbContext
{
    ...
    public virtual int sp_UrunEkle(string urunAdi, string marka, string model, Nullable<decimal> fiyat, Nullable<int> stokMiktari, Nullable<System.DateTime> satinAlinmaTarihi, string tedarikciFirma)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UrunEkle", urunAdiParameter, markaParameter, modelParameter, fiyatParameter, stokMiktariParameter, satinAlinmaTarihiParameter, tedarikciFirmaParameter);
    }


    public virtual int sp_UrunGuncelle(Nullable<int> urunID, string marka, string model, string urunAdi, Nullable<decimal> fiyat, Nullable<int> stokMiktari, Nullable<System.DateTime> satinAlinmaTarihi, string tedarikciFirma)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_UrunGuncelle", urunIDParameter, markaParameter, modelParameter, urunAdiParameter, fiyatParameter, stokMiktariParameter, satinAlinmaTarihiParameter, tedarikciFirmaParameter);
    }
    ...
    public virtual ObjectResult<DepartmanaGoresp_ZimmetListele_Result> DepartmanaGoresp_ZimmetListele(Nullable<int> departmanID)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DepartmanaGoresp_ZimmetListele_Result>("DepartmanaGoresp_ZimmetListele", departmanIDParameter);
    }


    public virtual ObjectResult<sp_AtikListele2_Result> sp_AtikListele2()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_AtikListele2_Result>("sp_AtikListele2");
    }


    public virtual ObjectResult<sp_ZimmetAra_Result> sp_ZimmetAra(Nullable<int> zimmetID)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ZimmetAra_Result>("sp_ZimmetAra", zimmetIDParameter);
    }


    public virtual ObjectResult<sp_DepartmanaGoreZimmetListele_Result> sp_DepartmanaGoreZimmetListele(Nullable<int> departmanID)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_DepartmanaGoreZimmetListele_Result>("sp_DepartmanaGoreZimmetListele", departmanIDParameter);
    }


    public virtual ObjectResult<sp_UrunListeleme_Result> sp_UrunListeleme()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_UrunListeleme_Result>("sp_UrunListeleme");
    }


    public virtual ObjectResult<sp_AtikListeleme1_Result> sp_AtikListeleme1()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_AtikListeleme1_Result>("sp_AtikListeleme1");
    }


    public virtual ObjectResult<sp_AtikListesi_Result> sp_AtikListesi()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_AtikListesi_Result>("sp_AtikListesi");
    }
